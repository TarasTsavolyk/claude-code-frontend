...
- **One home per rule:** checklists/criteria live in exactly one rule file; the matching skill and agent carry *process* only and point at the rule — don't restate rule content in them. 
